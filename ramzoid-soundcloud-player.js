...
(function ($) {
    ...
    $(document).on("click", "a.sc-info-toggle, a.sc-info-close", function (
        event
    ) {
        var $link = $(this);
        $link
    ...
    $(document).on("click", ".sc-trackslist li", function (event) {
        ...
        if (play) {
            ...
            // $("ol.sc-trackslist").each(function (index, element) {
            //     // log("child");
            //     // log(element.children());
            //     // log(element.children().find("a > i"));
            //     //log(element.find("li"));
            //     //element.find("a > i").removeClass('fa-pause-circle').addClass('fa-play-circle');
            //     element.each(function (index, item) {
            //         log(item)
            //     });
            // });
            $track.parent().find("li").find("a > i").removeClass('fa-pause-circle').addClass('fa-play-circle');
            $track.find("a > i").removeClass('fa-play-circle').addClass('fa-pause-circle');
            log("playing track");
        } else {
            onPause($player);
            $track.find("a > i").removeClass('fa-pause-circle').addClass('fa-play-circle');
            log("paused track");
        }
